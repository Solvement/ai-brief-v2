...
function repoForBoard(item, window, rank, options = {}) {
  ...
  const out = {
    ...
    informs_our_structure: Boolean(light.informs_our_structure || depthDecision.informs_our_structure),
    self_evo_eligible: Boolean(light.self_evo_eligible || depthDecision.self_evo_eligible),
...
function publicDepthDecision(light = {}) {
  ...
  return {
    ...
    informs_our_structure: Boolean(light.informs_our_structure || decision.informs_our_structure),
    self_evo_eligible: Boolean(light.self_evo_eligible || decision.self_evo_eligible),
