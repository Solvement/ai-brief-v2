...
[^hf]: Hugging Face paper page, arxiv:2605.29307；本次抓取页面显示作者发布的 `alireza7/GrepSeek-Qwen3.5-9B-GRPO`、`alireza7/GrepSeek-Qwen3.5-9B-SFT` 与 `alireza7/GrepSeek-ColdStart-SFT-10k` 关联资产。HF upvote 是动态页面指标，本文不把它作为论文结论。https://huggingface.co/papers/2605.29307
