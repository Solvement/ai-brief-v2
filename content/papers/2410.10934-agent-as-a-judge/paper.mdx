...
- **A Survey on Agent-as-a-Judge**(arXiv:2601.05111)— 成为"agentic 评测"子领域的首篇综述起点(LLM-as-a-Judge → Agent-as-a-Judge)_[置信度:高]_。
- **When AIs Judge AIs: The Rise of Agent-as-a-Judge Evaluation**(arXiv:2508.02994)— 围绕 Agent-as-a-Judge 组织的综述,内容完全一致 _[置信度:高]_。
- **Multi-Agent-as-Judge (MAJ-EVAL)**(arXiv:2507.21028)— 多智能体辩论评判,对齐多维人类评估,扩展(非替换)Agent-as-a-Judge _[置信度:中]_。
- **DRIFT: Span-Level Error Localization in Agent Trajectories**(arXiv:2606.02060)— claim-centric 审计:把"用智能体审计轨迹"推进到 span/claim 级(本站已深读)_[置信度:中]_。
