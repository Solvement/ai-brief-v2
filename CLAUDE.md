...
- **找问题 / 优化结构**：[docs/method/research-loop.md](./docs/method/research-loop.md)（RULES #18）——**科研不照抄**：论文当镜子照自己、自审找不出→真跑+跨模型对抗审、多法竞赛指标判、先把 benchmark 做强。L1 自进化 = 在**自己语料**上验证假设、进化自己结构，不搬别人的栈。
