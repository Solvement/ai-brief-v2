...
export interface PapersIndex {
  ...
  deepReads: Array<{ slug: string; arxiv_id: string; title: string; date: string; first_seen_date?: string; must_read?: boolean; foundational?: boolean; track?: string; venue?: string; authors: string[]; tags: string[]; scores: Record<string, number>; source_rankings: string[]; one_sentence_judgment: string; thumbnail_url: string }>;
